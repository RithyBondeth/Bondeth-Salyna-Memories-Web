...
export function createDreamsPage(): BookPage {
  return {
    ...
    subtitle:
      "January 2026 — the first time I did not have to imagine you beside me.",
    intro:
    ...
    note: "If I could choose one stretch of time to keep glowing in my memory, I would keep that one. The way you stood next to me made the world feel finally held.",
  };
}
